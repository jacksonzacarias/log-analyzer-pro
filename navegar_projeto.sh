...
echo -e "${GREEN}analogs/${RESET}         - Todos os logs organizados"
echo -e "${GREEN}system/data/${RESET}     - Dados e CSV"
...
echo -e "${GREEN}cd analogs/logs_realistas/${RESET} - Ver logs realistas"
...
echo -e "${GREEN}ls -la analogs/logs_realistas/${RESET}  - Listar logs realistas"
