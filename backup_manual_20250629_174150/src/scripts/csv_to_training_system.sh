...
ATTACK_PATTERNS_FILE="attack_patterns_learning.conf"
EVENT_PATTERNS_FILE="event_patterns_learning.conf"
LOG_TYPES_FILE="log_types_learning.conf"
IMPORT_HISTORY="import_history.log"
