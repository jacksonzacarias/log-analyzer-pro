...
LOGS_ATTACKS="$PROJECT_ROOT/analogs/attacks"
LOGS_SERVICES="$PROJECT_ROOT/analogs/services"
DATA_DIR="$PROJECT_ROOT/system/data"
PATTERNS_DIR="$DATA_DIR/import/csv/patterns"
